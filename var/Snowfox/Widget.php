...
use Snowfox\Widget\Helper\EmptyClass;
use Snowfox\Widget\Request as WidgetRequest;
use Snowfox\Widget\Response as WidgetResponse;
use Snowfox\Widget\Terminal;
...
abstract class Widget
{
    ...
    {
        if (Common::nativeClassName(static::class) == 'Snowfox_Widget') {
            if (isset($alias)) {
