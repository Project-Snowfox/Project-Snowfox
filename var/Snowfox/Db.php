...
use Snowfox\Db\Adapter;
use Snowfox\Db\Query;
use Snowfox\Db\Exception as DbException;

/**
 * 包含获取数据支持方法的类.
 * 必须定义__Snowfox_DB_HOST__, __Snowfox_DB_PORT__, __Snowfox_DB_NAME__,
 * __Snowfox_DB_USER__, __Snowfox_DB_PASS__, __Snowfox_DB_CHAR__
 *
 * @package Db
 */
class Db
{
     ...
     * @throws DbException
     */
    public function __construct($adapterName, string $prefix = 'Snowfox_')
    {
        /** 获取适配器名称 */
        ...
        /** 数据库适配器 */
        $adapterName = '\Snowfox\Db\Adapter\\' . str_replace('_', '\\', $adapterName);
