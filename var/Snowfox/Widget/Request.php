...
namespace Snowfox\Widget;

use Snowfox\Config;
use Snowfox\Request as HttpRequest;
...
class Request
{
    ...
    private const FILTERS = [
        ...
        'search'  => ['\Snowfox\Common', 'filterSearchQuery'],
        'xss'     => ['\Snowfox\Common', 'removeXSS'],
        'url'     => ['\Snowfox\Common', 'safeUrl'],
        'slug'    => ['\Snowfox\Common', 'slugName']
    ];
