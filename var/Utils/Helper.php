...
class Helper
{
    ...
    public static function removePlugin(string $pluginName)
    {
        try {
            ...
            [$pluginFileName, $className] = Plugin::portal(
                $pluginName,
                __Snowfox_ROOT_DIR__ . '/' . __Snowfox_PLUGIN_DIR__
            );
    ...
    public static function replyLink(
        ...
        if (self::options()->commentsThreaded) {
            echo '<a href="#' . $formId . '" rel="nofollow" onclick="return SnowfoxAddCommentReply(\'' .
    ...
    {
        if (self::options()->commentsThreaded) {
            echo '<a href="#' . $formId . '" rel="nofollow" onclick="return SnowfoxCancelCommentReply(\'' .
                $formId . '\');">' . $word . '</a>';
        }
    }
...
var SnowfoxAddCommentReply = function (cid, coid, cfid, style) {
...
var SnowfoxCancelCommentReply = function (cfid) {
    var _cf = document.getElementById(cfid),
