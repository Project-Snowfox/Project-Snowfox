...
class Upload extends Contents implements ActionInterface
{
    ...
    public static function deleteHandle(array $content): bool
    {
        ...
        return @unlink(__Snowfox_ROOT_DIR__ . '/' . $content['attachment']->path);
    }
    ...
    public static function attachmentHandle(Config $attachment): string
    {
        ...
        return Common::url(
            $attachment->path,
            defined('__Snowfox_UPLOAD_URL__') ? __Snowfox_UPLOAD_URL__ : $options->siteUrl
        );
    }
    ...
    public static function attachmentDataHandle(array $content): string
    {
        ...
        return file_get_contents(
            Common::url(
                ...
                defined('__Snowfox_UPLOAD_ROOT_DIR__') ? __Snowfox_UPLOAD_ROOT_DIR__ : __Snowfox_ROOT_DIR__
            )
        );
    }
    ...
    public static function uploadHandle(array $file)
    {
        ...
        $date = new Date();
        $path = Common::url(
            defined('__Snowfox_UPLOAD_DIR__') ? __Snowfox_UPLOAD_DIR__ : self::UPLOAD_DIR,
            defined('__Snowfox_UPLOAD_ROOT_DIR__') ? __Snowfox_UPLOAD_ROOT_DIR__ : __Snowfox_ROOT_DIR__
        ...
        return [
            'name' => $file['name'],
            'path' => (defined('__Snowfox_UPLOAD_DIR__') ? __Snowfox_UPLOAD_DIR__ : self::UPLOAD_DIR)
