...
class Register extends Users implements ActionInterface
{
    ...
    public function action()
    {
        ...
        if ($error = $validator->run($this->request->from('name', 'password', 'mail', 'confirm'))) {
            Cookie::set('__Snowfox_remember_name', $this->request->get('name'));
            Cookie::set('__Snowfox_remember_mail', $this->request->get('mail'));
        ...
        Cookie::delete('__Snowfox_first_run');
        Cookie::delete('__Snowfox_remember_name');
        Cookie::delete('__Snowfox_remember_mail');
