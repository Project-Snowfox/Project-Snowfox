...
class Feedback extends Comments implements ActionInterface
{
    ...
    private function comment()
    {
        ...
        if (!$this->user->hasLogin()) {
            ...
            $expire = 30 * 24 * 3600;
            Cookie::set('__Snowfox_remember_author', $comment['author'], $expire);
            Cookie::set('__Snowfox_remember_mail', $comment['mail'], $expire);
            Cookie::set('__Snowfox_remember_url', $comment['url'], $expire);
        } else {
        ...
        if ($error = $validator->run($comment)) {
            /** 记录文字 */
            Cookie::set('__Snowfox_remember_text', $comment['text']);
        ...
        Cookie::delete('__Snowfox_remember_text');
        ...
        if ($this->status !== 'approved') {
            Cookie::set('__Snowfox_unapproved_comment', $commentId);
        }
