...
?>
<div class="main">
    <div class="container Snowfox-dashboard">
            ...
            <div class="col-mb-12 welcome-board" role="main">
                ...
                <ul id="start-link" class="clearfix">
                    <?php if ($user->pass('contributor', true)): ?>
                        ...
                        <?php if ($user->pass('editor', true) && 'on' == $request->get('__Snowfox_all_comments') && $stat->waitingCommentsNum > 0): ?>
                            <li>
                        ...
                        <?php endif; ?>
                        <?php if ($user->pass('editor', true) && 'on' == $request->get('__Snowfox_all_comments') && $stat->spamCommentsNum > 0): ?>
                            <li>
...
<script>
    $(document).ready(function () {
        var ul = $('#Snowfox-message ul'), cache = window.sessionStorage,
        ...
        function applyUpdate(update) {
            if (update.available) {
                $('<div class="update-check message error"><p>'
                    ...
                    .insertAfter('.Snowfox-page-title').effect('highlight');
            }
        }
