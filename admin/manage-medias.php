            ...
            <div class="col-mb-12">
                ...
                <form method="post" name="manage_medias" class="operate-form">
                    <div class="Snowfox-table-wrap">
                        <table class="Snowfox-list-table draggable">
                            <colgroup>
                            ...
                            <?php if ($attachments->have()): ?>
                                <?php while ($attachments->next()): ?>
                                    <?php $mime = \Snowfox\Common::mimeIconType($attachments->attachment->mime); ?>
                                    <tr id="<?php $attachments->theId(); ?>">
                                        ...
                                        <td class="kit-hidden-mb"><a
                                                ...
                                                class="balloon-button size-<?php echo \Snowfox\Common::splitByCount($attachments->commentsNum, 1, 10, 20, 50, 100); ?>"><?php $attachments->commentsNum(); ?></a>
                                        </td>
                                        <td>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="6"><h6 class="Snowfox-list-table-title"><?php _e('没有任何文件'); ?></h6>
                                    </td>
                                </tr>
                            <?php endif; ?>
                            </tbody>
