...
<div class="main">
    <div class="body container">
        ...
        <div class="row Snowfox-page-main" role="main">
            <div class="col-mb-12">
                <ul class="Snowfox-option-tabs fix-tabs clearfix">
            ...
            <div class="Snowfox-edit-theme">
                <div class="col-mb-12 col-tb-8 col-9 content">
                    <form method="post" name="theme" id="theme"
                        ...
                        <p class="Snowfox-option Snowfox-option-submit">
...
\Snowfox\Plugin::factory('admin/theme-editor.php')->call('bottom', $files);
include 'footer.php';
?>
