        ...
        <div class="row Snowfox-page-main" role="main">
            <div class="col-mb-12 Snowfox-list">
                ...
                <?php if ($activatedPlugins->have() || !empty($activatedPlugins->activatedPlugins)): ?>
                    <h4 class="Snowfox-list-table-title"><?php _e('启用的插件'); ?></h4>
                                ...
                                <tr id="plugin-<?php $activatedPlugins->name(); ?>">
                                    <td><?php $activatedPlugins->title(); ?>
                                        <?php if (!$activatedPlugins->dependence): ?>
                                            <i class="i-delete"
                                               title="<?php _e('%s 无法在此版本的Snowfox下正常工作', $activatedPlugins->title); ?>"></i>
                                        <?php endif; ?>
                                    </td>
                ...
                <?php if ($deactivatedPlugins->have() || !$activatedPlugins->have()): ?>
                    <h4 class="Snowfox-list-table-title"><?php _e('禁用的插件'); ?></h4>
                    <div class="Snowfox-table-wrap">
                        <table class="Snowfox-list-table deactivate">
                            <colgroup>
                                <col width="25%"/>
                                <col width="45%"/>
                                <col width="8%" class="kit-hidden-mb"/>
                            ...
                            <tr>
                                ...
                                <th class="kit-hidden-mb"><?php _e('版本'); ?></th>
                                <th class="kit-hidden-mb"><?php _e('作者'); ?></th>
                                <th class="Snowfox-radius-topright"><?php _e('操作'); ?></th>
                            </tr>
                            </thead>
                            <tbody>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="5"><h6 class="Snowfox-list-table-title"><?php _e('没有安装插件'); ?></h6>
                                    </td>
                                </tr>
                            <?php endif; ?>
                            </tbody>
