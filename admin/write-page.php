                ...
                <div class="col-mb-12 col-tb-9" role="main">
                    <?php if ($page->draft): ?>
                        <?php if ($page->draft['cid'] != $page->cid): ?>
                            <?php $pageModifyDate = new \Snowfox\Date($page->draft['modified']); ?>
                            <cite
                    ...
                    <?php $permalink = \Snowfox\Common::url($options->routingTable['page']['url'], $options->index);
                    ...
                    <?php \Snowfox\Plugin::factory('admin/write-page.php')->call('content', $page); ?>
                </div>
                <div id="edit-secondary" class="col-mb-12 col-tb-3" role="complementary">
                    ...
                    <div id="tab-advance" class="tab-content">
                        ...
                        <section class="Snowfox-post-option">
                            <label for="order" class="Snowfox-label"><?php _e('页面顺序'); ?></label>
                        ...
                        <section class="Snowfox-post-option">
                            <label for="template" class="Snowfox-label"><?php _e('自定义模板'); ?></label>
                            <p>
                        ...
                        <section class="Snowfox-post-option">
                            <label for="parent" class="Snowfox-label"><?php _e('父级页面'); ?></label>
                            <p>
                        ...
                        <?php \Snowfox\Plugin::factory('admin/write-page.php')->call('option', $page); ?>
                        ...
                        <div id="advance-panel">
                            ...
                            <?php \Snowfox\Plugin::factory('admin/write-page.php')->call('advanceOption', $page); ?>
                        </div>
                        <?php if ($page->have()): ?>
                            <?php $modified = new \Snowfox\Date($page->modified); ?>
                            <section class="Snowfox-post-option">
                                <p class="description">
                                    <br>&mdash;<br>
                                    <?php _e('本页面由 <a href="%s">%s</a> 创建',
                                        \Snowfox\Common::url('manage-pages.php?uid=' . $page->author->uid, $options->adminUrl), $page->author->screenName); ?>
                                    <br>
...
\Snowfox\Plugin::factory('admin/write-page.php')->trigger($plugged)->call('richEditor', $page);
if (!$plugged) {
...
\Snowfox\Plugin::factory('admin/write-page.php')->bottom($page);
include 'footer.php';
?>
