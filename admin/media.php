            ...
            <div class="col-mb-12 col-tb-8" role="main">
                <?php if ($attachment->attachment->isImage): ?>
                    <p><img src="<?php $attachment->attachment->url(); ?>"
                            alt="<?php $attachment->attachment->name(); ?>" class="Snowfox-attachment-photo"/></p>
                <?php endif; ?>

                <p>
                    <?php $mime = \Snowfox\Common::mimeIconType($attachment->attachment->mime); ?>
    ...
    $(document).ready(function () {
        ...
        Snowfox.uploadComplete = function (attachment) {
            if (attachment.isImage) {
                $('.Snowfox-attachment-photo').attr('src', attachment.url + '?' + Math.random());
            }
