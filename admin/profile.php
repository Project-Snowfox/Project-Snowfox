        ...
        <div class="row Snowfox-page-main">
            <div class="col-mb-12 col-tb-3">
                <p><a href="https://gravatar.com/"
                      title="<?php _e('在 Gravatar 上修改头像'); ?>"><?php echo '<img class="profile-avatar" src="' . \Snowfox\Common::gravatarUrl($user->mail, 220, 'X', 'mm', $request->isSecure()) . '" alt="' . $user->screenName . '" />'; ?></a>
                </p>
            ...
            <div class="col-mb-12 col-tb-6 col-tb-offset-1 Snowfox-content-panel" role="form">
                <section>
                    <h3><?php _e('个人资料'); ?></h3>
...
include 'form-js.php';
\Snowfox\Plugin::factory('admin/profile.php')->call('bottom');
include 'footer.php';
?>
