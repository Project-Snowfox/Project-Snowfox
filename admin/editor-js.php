...
(function () {
    ...
    // 原始的插入图片和文件
    Snowfox.insertFileToEditor = function (file, url, isImage) {
...
$(document).ready(function () {
    ...
    <?php \Snowfox\Plugin::factory('admin/editor-js.php')->call('markdownEditor', $content); ?>
    ...
    const uploadBtn = $('<button type="button" id="btn-fullscreen-upload" class="btn btn-link">'
            ...
            .click(function() {
                $('a', $('.Snowfox-option-tabs li').not('.active')).trigger('click');
                return false;
            });

    $('.Snowfox-option-tabs li').click(function () {
    ...
    function initMarkdown() {
        ...
        Snowfox.uploadComplete = function (attachment) {
            Snowfox.insertFileToEditor(attachment.title, attachment.url, attachment.isImage);
        };
