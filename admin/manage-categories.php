...
<div class="main">
    <div class="body container">
        ...
        <div class="row Snowfox-page-main manage-metas">
                ...
                <form method="post" name="manage_categories" class="operate-form">
                    ...
                    <div class="Snowfox-table-wrap">
                        <table class="Snowfox-list-table">
                                ...
                                <?php while ($categories->next()): ?>
                                    <tr id="mid-<?php $categories->theId(); ?>">
                                        ...
                                        <td class="kit-hidden-mb"><a
                                                class="balloon-button left size-<?php echo \Snowfox\Common::splitByCount($categories->count, 1, 10, 20, 50, 100); ?>"
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="6"><h6 class="Snowfox-list-table-title"><?php _e('没有任何分类'); ?></h6>
                                    </td>
                                </tr>
                            <?php endif; ?>
                            </tbody>
...
<script type="text/javascript">
    (function () {
        $(document).ready(function () {
            var table = $('.Snowfox-list-table').tableDnD({
                onDrop: function () {
                    var ids = [];
            ...
            $('.Snowfox-mini-panel').effect('highlight', '#AACB36');
            <?php endif; ?>
        });
    })();
</script>
