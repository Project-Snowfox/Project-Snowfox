...
$isAllPosts = ('on' == $request->get('__Snowfox_all_posts') || 'on' == \Snowfox\Cookie::get('__Snowfox_all_posts'));
?>
<div class="main">
                    ...
                    <ul class="Snowfox-option-tabs right">
                        <?php if ($user->pass('editor', true) && !isset($request->uid)): ?>
                            <li class="<?php if ($isAllPosts): ?> current<?php endif; ?>"><a
                                    href="<?php echo $request->makeUriByRequest('__Snowfox_all_posts=on&page=1'); ?>"><?php _e('所有'); ?></a>
                            </li>
                            <li class="<?php if (!$isAllPosts): ?> current<?php endif; ?>"><a
                                    href="<?php echo $request->makeUriByRequest('__Snowfox_all_posts=off&page=1'); ?>"><?php _e('我的'); ?></a>
                            </li>
                        <?php endif; ?>
                    </ul>
                    ...
                    <div class="Snowfox-table-wrap">
                        <table class="Snowfox-list-table">
                            ...
                            <?php if ($posts->have()): ?>
                                <?php while ($posts->next()): ?>
                                    <tr id="<?php $posts->theId(); ?>">
                                        ...
                                        <td class="kit-hidden-mb"><a
                                                ...
                                                class="balloon-button size-<?php echo \Snowfox\Common::splitByCount($posts->commentsNum, 1, 10, 20, 50, 100); ?>"
                                        ...
                                        <td class="kit-hidden-mb"><a
                                                href="<?php $options->adminUrl('manage-posts.php?__Snowfox_all_posts=off&uid=' . $posts->author->uid); ?>"><?php $posts->author(); ?></a>
                                        </td>
                                ...
                                <?php $modifyDate = new \Snowfox\Date($posts->revision ? $posts->revision['modified'] : $posts->modified); ?>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="6"><h6 class="Snowfox-list-table-title"><?php _e('没有任何文章'); ?></h6>
                                    </td>
                                </tr>
                            <?php endif; ?>
                            </tbody>
