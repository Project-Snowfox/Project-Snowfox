                    ...
                    <div class="Snowfox-table-wrap">
                        <table class="Snowfox-list-table">
                            ...
                            <?php if ($pages->have()): ?>
                                <?php while ($pages->next()): ?>
                                    <tr id="<?php $pages->theId(); ?>">
                                        ...
                                        <td class="kit-hidden-mb"><a
                                                ...
                                                class="balloon-button size-<?php echo \Snowfox\Common::splitByCount($pages->commentsNum, 1, 10, 20, 50, 100); ?>"
                                ...
                                <?php $modifyDate = new \Snowfox\Date($pages->revision ? $pages->revision['modified'] : $pages->modified); ?>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="6"><h6 class="Snowfox-list-table-title"><?php _e('没有任何页面'); ?></h6>
                                    </td>
                                </tr>
                            <?php endif; ?>
                            </tbody>
