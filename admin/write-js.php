...
<?php \Snowfox\Plugin::factory('admin/write-js.php')->call('write'); ?>
...
$(document).ready(function() {
    ...
    // text 自动拉伸
    Snowfox.editorResize('text', '<?php $security->index('/action/ajax?do=editorResize'); ?>');
    ...
    // 控制选项和附件的切换
    $('#edit-secondary .Snowfox-option-tabs li').click(function() {
        $('#edit-secondary .Snowfox-option-tabs li.active').removeClass('active');
