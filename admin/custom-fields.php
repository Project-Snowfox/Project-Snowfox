...
<section id="custom-field"
         class="Snowfox-post-option<?php if (empty($defaultFields) && empty($fields)): ?> fold<?php endif; ?>">
    <label id="custom-field-expand" class="Snowfox-label"><a href="##"><i
                class="i-caret-right"></i> <?php _e('自定义字段'); ?></a></label>
    <table class="Snowfox-list-table mono">
        <colgroup>
            <col width="20%"/>
            <col width="15%"/>
            <col width="55%"/>
