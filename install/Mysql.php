...
<ul class="Snowfox-option">
    <li>
        <label class="Snowfox-label" for="dbHost"><?php _e('数据库地址'); ?></label>
...
<ul class="Snowfox-option">
    <li>
        <label class="Snowfox-label" for="dbUser"><?php _e('数据库用户名'); ?></label>
...
<ul class="Snowfox-option">
    <li>
        <label class="Snowfox-label" for="dbPassword"><?php _e('数据库密码'); ?></label>
        <input type="password" class="text" name="dbPassword" id="dbPassword" value="" />
    </li>
</ul>
<ul class="Snowfox-option">
    <li>
        <label class="Snowfox-label" for="dbDatabase"><?php _e('数据库名'); ?></label>
...
<details>
    ...
    <ul class="Snowfox-option">
        <li>
            <label class="Snowfox-label" for="dbPort"><?php _e('数据库端口'); ?></label>
    ...
    <ul class="Snowfox-option">
        <li>
            <label class="Snowfox-label" for="dbCharset"><?php _e('数据库编码'); ?></label>
    ...
    <ul class="Snowfox-option">
        <li>
            <label class="Snowfox-label" for="dbEngine"><?php _e('数据库引擎'); ?></label>
    ...
    <ul class="Snowfox-option">
        <li>
            <label class="Snowfox-label" for="dbSslCa"><?php _e('数据库 SSL 证书'); ?></label>
    ...
    <ul class="Snowfox-option">
        <li>
            <label class="Snowfox-label" for="dbSslVerify"><?php _e('启用数据库 SSL 服务端证书验证'); ?></label>
